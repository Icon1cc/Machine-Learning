...
Design a production-minded chatbot with rag case study for grounded question answering. The system should use user question, conversation state, retrieved passages, source metadata, and safety context
to produce answer with citations, uncertainty, and escalation when evidence is missing. The goal is to show how a practical ML or AI design moves from product framing
