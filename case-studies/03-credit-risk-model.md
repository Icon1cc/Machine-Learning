...
Design a production-minded credit risk model case study for loan underwriting. The system should use application fields, credit history, income signals, debt ratios, and repayment outcomes
to produce risk tier, approval recommendation, limit, or pricing band. The goal is to show how a practical ML or AI design moves from product framing
