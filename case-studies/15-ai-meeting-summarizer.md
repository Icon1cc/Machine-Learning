...
Design a production-minded ai meeting summarizer case study for meeting notes and action tracking. The system should use transcript, speaker turns, calendar metadata, chat messages, and organization policy
to produce summary, decisions, action items, owners, deadlines, and uncertainty markers. The goal is to show how a practical ML or AI design moves from product framing
