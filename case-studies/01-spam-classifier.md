...
Design a production-minded spam classifier case study for email and message moderation. The system should use message body, subject, sender reputation, links, attachments, and user reports
to produce spam, likely spam, or clean with a calibrated confidence score. The goal is to show how a practical ML or AI design moves from product framing
