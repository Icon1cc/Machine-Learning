...
Design a production-minded vector search at scale case study for large-scale approximate nearest neighbor retrieval. The system should use embeddings, metadata, index versions, query vectors, filters, and relevance judgments
to produce nearest candidates with scores, filters, and index trace metadata. The goal is to show how a practical ML or AI design moves from product framing
