...
Design a production-minded semantic search engine case study for meaning-based knowledge retrieval. The system should use queries, documents, metadata, embeddings, permissions, and click or judgment feedback
to produce ranked passages or documents with matched evidence. The goal is to show how a practical ML or AI design moves from product framing
