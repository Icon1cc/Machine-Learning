...
Design a production-minded personalization engine case study for personalized product experience. The system should use user profile, behavior history, context, catalog metadata, constraints, and feedback
to produce personalized layout, ranking, message, or offer with guardrails. The goal is to show how a practical ML or AI design moves from product framing
