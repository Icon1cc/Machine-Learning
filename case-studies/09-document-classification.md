...
Design a production-minded document classification case study for document routing and compliance triage. The system should use document text, layout metadata, source, language, and human labels
to produce document class, confidence, and fields required for downstream routing. The goal is to show how a practical ML or AI design moves from product framing
