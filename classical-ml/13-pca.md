...
PCA is easiest to understand by asking what problem it helps you solve. In this part of machine
...
PCA finds directions of maximum variance and projects data into a lower-dimensional space. More formally, the concept should be described by its assumptions, its inputs and
...
**Question:** Explain PCA, then describe how you would use it in a real system.
