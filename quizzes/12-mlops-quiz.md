...
1. In the context of MLOps, what should you clarify first?
...
Create one additional question about a failure mode in MLOps, then answer it with the same level
