...
| 19 | Case studies | `case-studies/` | Write architecture notes | Choose one case | Metrics and failure modes |
| 20 | Capstone and mocks | `capstone-projects/, mocks/` | Finish portfolio story | Capstone demo | Full mock loop |
...
1. Choose one guide from [capstone-projects/](capstone-projects/).
