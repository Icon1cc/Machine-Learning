...
Design a production-minded recommendation system case study for personalized content or product discovery. The system should use user events, item metadata, inventory state, impressions, clicks, purchases, and negative feedback
to produce ranked candidates with reasons and diversity controls. The goal is to show how a practical ML or AI design moves from product framing
