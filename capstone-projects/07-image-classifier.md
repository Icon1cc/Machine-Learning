...
Build an end-to-end image classifier that demonstrates real machine learning engineering skill:
...
- Built an end-to-end image classifier with documented data pipeline, baseline, model comparison, and
evaluation.
