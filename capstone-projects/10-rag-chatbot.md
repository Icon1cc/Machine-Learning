...
Build an end-to-end rag chatbot that demonstrates real machine learning engineering skill:
...
- Built an end-to-end rag chatbot with documented data pipeline, baseline, model comparison, and
evaluation.
