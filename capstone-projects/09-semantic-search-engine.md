...
Build an end-to-end semantic search engine that demonstrates real machine learning engineering skill:
...
- Built an end-to-end semantic search engine with documented data pipeline, baseline, model comparison, and
evaluation.
