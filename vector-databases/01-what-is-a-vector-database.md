...
A vector database stores embeddings and indexes them for fast similarity search. More formally, the concept should be described by its assumptions, its inputs and
