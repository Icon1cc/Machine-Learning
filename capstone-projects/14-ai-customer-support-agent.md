...
Build an end-to-end ai customer support agent that demonstrates real machine learning engineering skill:
...
- Built an end-to-end ai customer support agent with documented data pipeline, baseline, model comparison, and
evaluation.
