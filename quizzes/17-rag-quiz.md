...
1. In the context of RAG, what should you clarify first?
...
Create one additional question about a failure mode in RAG, then answer it with the same level
