...
Design a production-minded enterprise knowledge assistant case study for internal company knowledge access. The system should use documents, permissions, freshness metadata, employee query, and audit context
to produce permission-aware answer with source links and escalation options. The goal is to show how a practical ML or AI design moves from product framing
