...
Build an end-to-end production ml platform that demonstrates real machine learning engineering skill:
...
- Built an end-to-end production ml platform with documented data pipeline, baseline, model comparison, and
evaluation.
