...
Design a production-minded customer support agent case study for support automation. The system should use ticket text, account state, policy documents, prior cases, tools, and escalation rules
to produce draft response, next action, or routed ticket with confidence and evidence. The goal is to show how a practical ML or AI design moves from product framing
