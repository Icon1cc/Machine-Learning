...
Build an end-to-end nlp text classifier that demonstrates real machine learning engineering skill:
...
- Built an end-to-end nlp text classifier with documented data pipeline, baseline, model comparison, and
evaluation.
