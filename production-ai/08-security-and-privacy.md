...
Security and Privacy is part of the larger skill of using data to make better decisions. At a beginner level,
...
In formal ML work, security and privacy should be described through inputs, outputs, assumptions, and an
objective. For this lesson, the core definition is: limit collection, exposure, and retention of sensitive information. A rigorous explanation also names the
data distribution, the parameters or rules being learned, and the metric used to judge generalization.

Key pieces:

- Core idea: limit collection, exposure, and retention of sensitive information.
- Input: the data, assumptions, or constraints that make security and privacy meaningful.
...
When you use security and privacy at work, you should be able to explain what can go wrong, what you would
...
A document assistant uses caching, model routing, retrieval, guardrails, and human review for high-risk actions. In that setting, security and privacy helps the team move from a vague request to a
...
- Using security and privacy because it sounds advanced instead of because it matches the problem.
...
- Memorizing the definition of security and privacy without being able to trace the data flow.

## Interview Angle

Interviewers use security and privacy to test whether you understand fundamentals rather than memorized
phrases.

**Question:** Explain security and privacy to a product manager and then to a senior ML engineer.
...
Pick a product you use every week. Write down one place where security and privacy could appear. Define
