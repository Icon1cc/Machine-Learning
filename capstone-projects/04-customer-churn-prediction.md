...
Build an end-to-end customer churn prediction that demonstrates real machine learning engineering skill:
...
- Built an end-to-end customer churn prediction with documented data pipeline, baseline, model comparison, and
evaluation.
