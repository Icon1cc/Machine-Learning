...
Use this cheatsheet to revise Agents quickly. The central pattern is always the same: define the
...
Use this cheatsheet to explain Agents in two minutes. Record the answer and check whether it
