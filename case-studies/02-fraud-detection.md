...
Design a production-minded fraud detection case study for payments and account risk. The system should use transaction amount, merchant, device, account age, velocity features, location, and prior disputes
to produce approve, challenge, block, or route to review. The goal is to show how a practical ML or AI design moves from product framing
