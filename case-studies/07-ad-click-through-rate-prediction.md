...
Design a production-minded ad click through rate prediction case study for ads ranking. The system should use ad features, user context, page context, bid, historical impressions, clicks, and conversions
to produce click probability used by ranking or auction logic. The goal is to show how a practical ML or AI design moves from product framing
