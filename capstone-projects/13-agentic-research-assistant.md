...
Build an end-to-end agentic research assistant that demonstrates real machine learning engineering skill:
...
- Built an end-to-end agentic research assistant with documented data pipeline, baseline, model comparison, and
evaluation.
