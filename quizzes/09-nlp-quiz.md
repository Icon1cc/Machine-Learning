...
1. In the context of NLP, what should you clarify first?
...
Create one additional question about a failure mode in NLP, then answer it with the same level
