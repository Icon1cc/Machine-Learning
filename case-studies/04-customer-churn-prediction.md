...
Design a production-minded customer churn prediction case study for subscription retention. The system should use usage history, billing events, support tickets, plan changes, tenure, and engagement trends
to produce churn probability, risk segment, and suggested retention action. The goal is to show how a practical ML or AI design moves from product framing
